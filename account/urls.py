...
urlpatterns = [
    ...
    path('register/provision/<uuid:inquiry_id>/', views.provision_school, name='provision-school'),
    ...
    path('upgrade/<uuid:new_package_id>/', views.upgrade_package, name='upgrade-package'),
    path('downgrade/<uuid:new_package_id>/', views.downgrade_package, name='downgrade-package'),
